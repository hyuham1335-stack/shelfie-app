...
**열린 질문 (런 #8이 답한다)**: 첨부는 **읽을** 파일에 값을 하고 **쓸** 파일에는 덜 하는가. 런 #7에서 step 2(접두부 최대·비용 최소)와 step 4(접두부 최소·비용 최대)가 정반대로 나와 반례가 이미 있다. 예산을 **접두부 총량**에 걸어야 하는지 **첨부의 성격**에 걸어야 하는지가 이 답에 달려 있다.
